...
Contributors: ounziw
Donate link: https://my-mitsu.com/
Description: You can embed an estimation(calculation) form with PDF output, provided by a webservice in Japan called My Mitsu.
Tags: shortcode, estimation, calculation, calculator, form, pdf
...
[Estimation Form Creator: My Mitsumori](https://my-mitsu.com/) (written in Japanese.)
